...
Splunk
------
- Configure a new index (e.g. netwaf) for the new logs
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~
NOTE: Its recommended to use a separate and dedicated syslog solution (e.g. rsyslog, syslog-ng, etc) for data persistence before forwarding it to Splunk.
